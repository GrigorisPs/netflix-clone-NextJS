        ...
        <main className="mx-auto max-w-5xl pt-28 px-5 pb-12 transition-all md:px-10">
            ...
            <ul>
                <li className="listStyle">
                    <CheckIcon className="listItem" />Watch all you want. Ad-free.</li>
                <li className=" listStyle">
                    <CheckIcon className="listItem" /> Recommendations just for you.</li>
                <li className="listStyle">
                    <CheckIcon className="listItem" /> Change or cancel
                    your plan anytime.
                </li>
            </ul>
