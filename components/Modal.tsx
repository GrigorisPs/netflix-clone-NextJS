...
function Modal() {
    ...
    useEffect(() => {
        ...
        async function fetchMovie() {
            const data = await fetch(`https://api.themoviedb.org/3/${movie?.media_type === 'tv' ? 'tv' : 'movie'
                }/${movie?.id}?api_key=${'b980ab418161262d715d1b02eddbec35'
    ...
    console.log(trailer, 'mydata')

    return (
        <MuiModal open={showModal} onClose={handleClose} className='fixex !top-7 left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll rounded-md
        scrollbar-hide'>
            <>
                ...
                <div className='relative pt-[56.25%]'>
                    ...
                    <div className='absolute bottom-10 flex w-full items-center justify-between px-10'>
                        <div className='flex space-x-2'>
                            <button className='flex items-center gap-x-2 rounded bg-white px-8 text-xl font-bold text-black
